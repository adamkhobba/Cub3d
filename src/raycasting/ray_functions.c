...
/*   Updated: 2025/03/21 01:20:45 by akhobba          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	fillline((t_point){data->player->pos.x * MINI_MAP,
		data->player->pos.y * MINI_MAP},
		(t_point){ray->wall_hit.x * MINI_MAP,
		ray->wall_hit.y * MINI_MAP}
		, ray->angle, 0xFF0000);
}
